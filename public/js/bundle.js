...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic29ld2VpeWFuIiwiYSI6ImNreGtkbGk1ZzZtM2UybnJuYmZ6NGM3b3IifQ.bFYYVtclwa2Y1eh6KZbT8g";
  ...
  var bounds = new mapboxgl.LngLatBounds(); // Create markers and popups.
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); // Create and add popups.
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    e.preventDefault(); // Get email and password.
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    // Prevent event from loading other pages.
    e.preventDefault(); // Get name and email.
